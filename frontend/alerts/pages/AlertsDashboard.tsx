...
//         const filterOptionsRes = await axiosInstance.get("filter-options");
...
//         const analysisRes = await axiosInstance.post(
//           "prediction-insights",
//           searchCriteria
//         );
...
//       try {
//         const response = await axiosInstance.get("filters/schools", {
//           params: { district },
//         });

//         const filteredSchools: SchoolOption[] = response.data.map(
//           (school: any) => ({
//             ...school,
...
//         const response = await axiosInstance.get("filters/grades", {
...
//         axiosInstance.post("prediction-insights", searchCriteria),
//         axiosInstance.get("filters/schools"),
//       ]);

//       const uniqueSchools = schoolsRes.data.reduce(
...
//         link.href = url;
//         link.download = `attendance_${reportType}_${
